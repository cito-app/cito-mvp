...
export default function PaginaPublicaNegocio() {
  ...
  const subdominio = pathname.split('/')[1] // Extraer subdominio de la URL
  ...
  useEffect(() => {
    const loadNegocio = async () => {
      console.log('🔍 Buscando subdominio:', subdominio)
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6 text-center">
          <div className="mb-6">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Selecciona el día y hora que mejor te convenga. Confirma tu cita de forma rápida y sencilla.
            </p>
          </div>

          {/* Call to Action - Próximamente calendario */}
          <div className="bg-gray-50 rounded-lg p-6 border-2 border-dashed border-gray-300">
            <div className="text-4xl mb-3">📅</div>
            <p className="text-gray-600 mb-4">
              El calendario de disponibilidad se mostrará aquí
            </p>
            <p className="text-sm text-gray-500">
              Próximamente podrás ver y seleccionar horarios disponibles
            </p>
          </div>
        </div>
