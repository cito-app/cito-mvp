...
export default function PerfilPage() {
  ...
  useEffect(() => {
    const getSession = async () => {
      ...
      if (!userError && user) {
        ...
        setDuracionCita(user.duracion_cita || 60)
        if (user.logo_url) {
  ...
  const handleCancel = () => {
    ...
    setDuracionCita(userData.duracion_cita || 60)
    setError('')
    setSuccess('')
    setLogoFile(null)
          ...
          <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-green-600 mt-1">
                Los cambios se aplicarán inmediatamente en tu dashboard y próximamente en tu página pública
              </p>
            </div>
          </div>
        )}
            ...
            <div>
              ...
              <div className="flex items-start gap-2 mt-2">
                ...
                <p className="text-xs text-gray-500">
                  Este es el enlace único que compartirás con tus clientes para agendar citas. El subdominio no se puede cambiar después del registro.
                </p>
              </div>
            </div>
          ...
          <div className="p-6 space-y-6">
                ...
                <div className="flex-1">
                  {isEditing ? (
                    <div className="space-y-3">
                      ...
                      <p className="text-xs text-gray-500">
                        📁 PNG, JPG o WEBP • Máx 2MB • Ideal: 512x512px cuadrado con fondo transparente
                      </p>
                    </div>
                  ) : (
                    <div>
            ...
            <div>
              ...
              <div className="flex items-start gap-2 mb-4">
                ...
                <p className="text-xs text-gray-500">
                  Este color se usará en tu página pública para botones, enlaces y elementos destacados. Elige un color que represente tu marca.
                </p>
              </div>
            ...
            <div>
              ...
              <div className="flex items-start gap-2 mb-4">
                ...
                <p className="text-xs text-gray-500">
                  Define cuánto tiempo dura cada cita. Esto determina cuántas citas caben en tus bloques de horario.
                </p>
              </div>
              ...
              {isEditing ? (
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    {[30, 45, 60, 90].map((minutos) => (
                      <button
                        key={minutos}
                        type="button"
                        onClick={() => setDuracionCita(minutos)}
                        disabled={saving}
                      ...
                      >
                        <p className={`text-2xl font-bold mb-1 ${
                          duracionCita === minutos ? 'text-blue-900' : 'text-gray-900'
                        }`}>
                          {minutos}
                        </p>
                        <p className={`text-xs ${
                          duracionCita === minutos ? 'text-blue-700' : 'text-gray-600'
                        }`}>
                          minutos
                        </p>
                      </button>
                  ...
                  <div className="bg-blue-50 p-3 rounded-lg">
                    <p className="text-xs text-blue-800">
                      {duracionCita === 30 && '⚡ Ideal para consultas rápidas o servicios express'}
                      {duracionCita === 45 && '⏰ Duración estándar para mayoría de servicios'}
                      {duracionCita === 60 && '🕐 Perfecto para consultas completas o sesiones largas'}
                      {duracionCita === 90 && '⏳ Para procedimientos extensos o consultas detalladas'}
                    </p>
                  </div>
                </div>
              ) : (
                <div className="flex items-center gap-3">
                  <div className="w-20 h-20 bg-blue-100 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      <p className="text-2xl font-bold text-blue-900">{userData.duracion_cita || 60}</p>
                      <p className="text-xs text-blue-700">min</p>
                    </div>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">
                      Cada cita dura <span className="font-semibold text-gray-900">{userData.duracion_cita || 60} minutos</span>
                    </p>
                    <p className="text-xs text-gray-500 mt-1">
                      Edita para cambiar la duración
                    </p>
                  </div>
                </div>
              )}
